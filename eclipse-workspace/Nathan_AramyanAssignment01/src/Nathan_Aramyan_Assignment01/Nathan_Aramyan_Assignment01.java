package Nathan_Aramyan_Assignment01;

import java.util.Scanner;

public class Nathan_Aramyan_Assignment01 {
	...
	public static void main(String[] args) {
		...
		if(answer == 'N' || answer == 'n') {
				System.out.println("Sorry to hear that you are not having fun.\n" 
						+ "Let read this story to see if it will better.\n\n"
						+"Once upon a time, in a land of technology, "
						+"there was a computer that started acting up.\n"+"It was producting random errors, freezing at the most" 
